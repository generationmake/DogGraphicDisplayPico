...
//  int dy = abs(y1-y0), sy = y0<y1 ? 1 : -1;
  int dx=0, dy=0, sx=0, sy=0; // hier noch murks
...
//    SPI.setClockDivider(SPI_CLOCK_DIV4);
    ...
    gpio_set_function(p_si, GPIO_FUNC_SPI);
    gpio_set_function(p_clk, GPIO_FUNC_SPI);
  }
}
